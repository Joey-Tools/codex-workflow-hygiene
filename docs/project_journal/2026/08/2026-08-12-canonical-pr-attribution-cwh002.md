...
- `python3 -B -m unittest tests.test_pr_attribution`: 48 tests passed.
- Full repository suite: 1,107 tests passed with commit signing disabled only for temporary Git fixtures.
