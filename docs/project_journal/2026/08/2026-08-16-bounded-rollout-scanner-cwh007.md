...
- Focused scanner and structure validation: `python3 -B -m unittest -q tests.test_scan_rollout tests.test_skill_structure` (`62` tests, passed).
- Full repository validation: `python3 -B -m unittest discover -s tests -b -q` (`244` tests, passed).
