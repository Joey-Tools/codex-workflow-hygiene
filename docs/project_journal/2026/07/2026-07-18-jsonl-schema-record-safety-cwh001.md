...
- `python3 -B -m unittest -b tests.test_session_retrospective`: 887 tests passed after the local/embedded scalar-field follow-up.
- The final full repository suite passed 1,017/1,017 tests after the retrospective schema follow-ups.
