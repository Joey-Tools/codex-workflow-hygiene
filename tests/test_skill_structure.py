...
class SkillStructureTests(unittest.TestCase):
    ...
    def test_session_mining_rollout_scanner_documentation_contract(self) -> None:
        ...
        self.assertIn("--category event", combined)
        self.assertIn("task_started", combined)
        self.assertIn("turn_aborted", workflow)
        self.assertIn("stream_error", workflow)
        self.assertIn("origin_hint", workflow)
        self.assertIn("record-level provenance", workflow)
